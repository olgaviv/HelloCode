/*// Зад1: Напишите программу, кот запрашивает 2 числа и провеляет является ли 1 число квадратом второго 
...
/*
//Зад Напишите программу которая на вход принимает одно число (N), а на выходе показывает все целые числа в промежутке от -N до N
